...
**CI rules:** [Y] = 0 fail + 0 pending. [N] = any fail. [...] = 0 fail + some pending. [LOCK] = all jobs skipping (fork PR -- needs maintainer to trigger CI, this is normal, not a failure).

**Bot rules:** [Y] = 0 unanswered. [N] = any unanswered -> auto-respond before reporting.
...
When CI has failures, don't just report [N] -- **classify each failure**:
...
- [Y] = all pass
- [...] = still running
- [WARN] = upstream failures only, our area passes -> **ready for review with triage**
- [N] = our code failing, or can't determine
...
+===============================================================+
 ...
 #123     open      [Y]    [Y]      Waiting (pinged 25h ago)
 #456     open      [N]    [Y]      Upstream fail, main recovered -> rebase
 #789     merged    [OK]    -       Archived context file
